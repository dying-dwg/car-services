...
<div class="navs-item" align="center"><a href="../adminpanel/redC.php"><button class="btn txt-uppercase">Работа с данными клиентов</button></a></div>
</br>
<div class="navs-item" align="center"><a href="../adminpanel/redN.php"><button class="btn txt-uppercase">Работа с данными новостей</button></a></div>
</br>
<div class="navs-item" align="center"><a href="../adminpanel/redP.php"><button class="btn txt-uppercase">Работа с данными продуктов</button></a></div>
